...
public enum Fruta {
    ...
    AMEIXA_ESTRANGEIRA ("Ameixa Estrangeira", Arrays.asList(1, 2, 3), Arrays.asList(0, 7, 8, 9, 11) ),
    AMEIXA_NACIONAL ("Ameixa Nacional", Arrays.asList(11), Arrays.asList(0, 1, 9, 10) ),
